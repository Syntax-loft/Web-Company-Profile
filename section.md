# Section di Setiap Halaman â€” Syntax Loft
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
## Global (Layout â€” `app/layout.tsx`)
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 1 | **Hero** | `Hero` sinematik terpusat: foto full-bleed + radial wash, H1 lebar max-w-6xl (maks 3 baris), 2 CTA kontras tinggi, tanpa stats/pill, parallax GSAP, scroll indicator
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 2 | **Client ticker** | `Marquee`
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 3 | **Bento Services** | Bento grid gapless 4-col x 3-row grid-flow-dense, 6 kartu: Web Development (2x2, gambar hover-scale), UI/UX Design (tipografi + inline pill image), System Integration, Performance First, process teaser, kutipan klien
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 4 | **Process** | `HorizontalAccordion` 4 slice (Discovery, Design, Engineering, Launch), melebar saat hover, stack vertikal di mobile
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 5 | **Manifesto** | `ScrubReveal`: opasitas kata scrub 0.08 menjadi 1 mengikuti scroll
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 6 | **Selected Work** | Heading + `WorkGallery`: media scale 0.82 ke 1.0 saat masuk viewport, fade ke 0.22 saat keluar, tombol View all work
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 7 | **CTA** | `CTASection`
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
## Tentang `/about` â€” `app/about/page.tsx`
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
## Layanan `/services` â€” `app/services/page.tsx`
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
## Portofolio `/work` â€” `app/work/page.tsx`
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 2 | **Filter** | 5 tombol kategori filter (All, Web Development, UI/UX Design, Mobile App, E-Commerce) â€” state `activeCategory` |
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
## Klien `/clients` â€” `app/clients/page.tsx`
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
## Kontak `/contact` â€” `app/contact/page.tsx`
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 2 | **Contact Content** | Layout 2-col: **Kiri** â€” Info kontak (Email: hello@syntaxloft.com, Phone: +62 812 3456 7890, Address: Jakarta, Indonesia), tombol "Schedule a Call" (Calendly). **Kanan** â€” Form kontak (Name, Email, Company, Service dropdown, Message), submit button "Send Message" |
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
## Project Brief `/project-brief` â€” `app/project-brief/page.tsx`
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 2 | **Process Steps** | 3 step card (Fill the Brief â†’ We Review â†’ Discovery Call) dalam grid 3-col, masing-masing dengan icon + nomor step |
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| 4 | **Alternative Contact** | 2 card (Email: hello@syntaxloft.com, Schedule a call â†’ /contact), background `bg-[#0f0f0f]` |
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
## AI Chat `/ai-chat` â€” `app/(chat)/ai-chat/page.tsx`
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| `ScrollReveal` / `StaggerContainer` / `StaggerItem` | `components/scroll-reveal.tsx` | Services, Clients |
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| `PortfolioCard` | `components/portfolio-card.tsx` | Work (grid) |
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| `MagneticButton` | `components/magnetic-button.tsx` | Home (Hero) |
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
...
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
| `Marquee` | `components/marquee.tsx` | Home (client ticker) |
| `ScrubReveal` | `components/scrub-reveal.tsx` | Home (manifesto) |
| `HorizontalAccordion` | `components/horizontal-accordion.tsx` | Home (process) |
| `WorkGallery` | `components/work-gallery.tsx` | Home (selected work) |
