...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-3xl border border-border/80 bg-[#121212] text-foreground shadow-2xl transition-all duration-300',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn('text-sm text-muted-dark font-light leading-relaxed', className)}
    {...props}
  />
))
